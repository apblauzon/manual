...
For the initial launch, users are given free 4,000 credits (or tokens) with additional 2,000 if you fill in our user experience survey. The number of credits used vary depending on the number of words used in prompts and length of output.
